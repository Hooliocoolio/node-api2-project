...
// //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// // GET FIND
// //xxxxxxxxxxxxxxxxxxłxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// router.get('/api/posts', (req, res) => {
//         data.find(req.params)
//     .then((posts) => {
...
//     .then((post) => {
//         if (!post) {
//             res.status(404).json({NoticeMessage: "Post not found"})
//             } else {
//             res.status(200).json(post)
//             }
//           })
...
//         })
// 	}
//     data.insert(res.body.id, res.body.text)
//     .then((post) => {
